 ...
 * @author ivan
 */
public class FGetARazmer extends javax.swing.JDialog {

    /**
     * Creates new form FGetARazmer
     * @param parent
     * @param modal
     * @param s
     */
    public FGetARazmer(java.awt.Frame parent, boolean modal, int s) {
        super(parent, modal);
        initComponents();
        createWindow(s);
        model.setData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetARazmer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FGetARazmer dialog = new FGetARazmer(new javax.swing.JFrame(), true, 0);
    ...
    int result_id;
    ModelARazmer model;// = new ModelColor();
    /**
     * Результат диалога
     * @return 
     */
