 ...
 * @author ivan
 */  
public class FGetPrognoz extends javax.swing.JPanel {

    /**
     * Creates new form FGetPrognoz
     * @param th1
     */
    public FGetPrognoz(THaupt th1) {
        initComponents();
        th = th1;
    ...
    ModelPrognoz model = new ModelPrognoz();
     ...
     */
    public void sendPadamert(int article, Date d1, Date d2, Date d3, Date d4, Date d5)
    {
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        jTable1.getTableHeader().setPreferredSize(new Dimension(2200, 80));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        jTable1.removeAll();
        model = new ModelPrognoz();
        model.setData(IOPrognoz.getDataForPrognoz(mod.getModel(), jDateChooser2.getDate(), jDateChooser1.getDate(), jDateChooser4.getDate()));
        jTable1.setModel(model);     
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        for(List<String> l: model.list)
        {
            ...
            if(HelpClass.GetIntIzText(l.get(l.size()-2))>0)
            {
