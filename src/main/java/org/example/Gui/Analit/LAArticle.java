 ...
 * @author ivan
 */
public class LAArticle extends javax.swing.JPanel {

    /**
     * Creates new form LAArticle
     * @param th1
     */
    public LAArticle(THaupt th1) {
        initComponents();
        th = th1;
    }
    THaupt th;
    ModelAArticle model = new ModelAArticle();
    ...
    private void initComponents() {
        ...
        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/example/images/1.png"))); // NOI18N
        jButton3.setText("Отвязать");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(h==-1) return;
        FGetModel fg = new FGetModel(null, true, (int)jTable1.getValueAt(h, 5));
        fg.setVisible(true);
        if(fg.getResult())
        {
            IOAHelp.snapArticle((int)jTable1.getValueAt(h, 0), fg.getResultValue());
            model.setData();     
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int h = jTable1.getSelectedRow();
        if(h==-1) return;
        IOAHelp.snapArticle((int)jTable1.getValueAt(h, 0), 0);
        model.setData();     
        jTable1.setRowSelectionInterval(h, h);        
