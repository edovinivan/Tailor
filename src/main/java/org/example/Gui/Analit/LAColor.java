 ...
 * @author ivan
 */
public class LAColor extends javax.swing.JPanel {

    /**
     * Creates new form LAColor
     * @param th1
     */
    public LAColor(THaupt th1) {
        initComponents();
        th = th1;
    }
    
    THaupt th;
    ModelAColor model = new ModelAColor();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        FGetColor fg = new FGetColor(null, true, (int)jTable1.getValueAt(h, 3), 1);
        fg.setVisible(true);
        if(fg.getResult())
        {            
            IOAHelp.snapColor((int)jTable1.getValueAt(h, 0), fg.getResultValue());
            model.setData();     
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int h = jTable1.getSelectedRow();
        if(h==-1) return;
        IOAHelp.snapColor((int)jTable1.getValueAt(h, 0), 0);
        model.setData();            
        jTable1.setRowSelectionInterval(h, h);
