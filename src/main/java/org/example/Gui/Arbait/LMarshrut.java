 ...
 * Список маршрутов
 */
public class LMarshrut extends javax.swing.JPanel {
     ...
     */
    public LMarshrut(THaupt th1, int stat) {
        initComponents();
        th = th1;
        //status = stat;
    ...
    THaupt th;
    //int status;
    ModelMarshrut model = new ModelMarshrut();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        FMarshrut m = new FMarshrut(null, true, (int)jTable1.getValueAt(jTable1.getSelectedRow(), 0));
        m.setVisible(true);
        model.setData(d1, d2, status, jCheckBox1.isSelected());
