...
import org.example.Gui.Arbait.Model.ModelPretenziaList;
 ...
 * @author ivan
 */
public class LPretenzia extends javax.swing.JPanel {

    /**
     * Creates new form LPretenzia
     * @param th1
     */
    public LPretenzia(THaupt th1) {
        initComponents();
        th = th1;
    }

    THaupt th;
    ModelPretenziaList model = new ModelPretenziaList();
    /**
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(h==-1) return;
        FPretenzia f = new FPretenzia(null, true,(int)jTable1.getValueAt(h, 0) , 0);
        f.setVisible(true);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(h==-1)
            return;
        if (JOptionPane.showConfirmDialog(null, "Вы действительно хотите удалить претензию по маршруту <" + jTable1.getValueAt(h, 2) + ">?", "Вопрос.", JOptionPane.YES_NO_OPTION) == 0) 
        {
            if(IOZadachaKomplektovkaPretenzia.delZKPretenzia((int)jTable1.getValueAt(h, 0))<0)            
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        LReport lr = new LReport(null, true,15 ,(int)jTable1.getValueAt(jTable1.getSelectedRow(), 0));
        lr.setVisible(true);
