 ...
 * @author ivan
 */
public class LScladLoskutSale extends javax.swing.JPanel {

    /**
     * Creates new form LScladLoskutSale
     * @param th1
     */
    public LScladLoskutSale(THaupt th1) {
        initComponents();
        th = th1;
    ...
    Date d1, d2;
    THaupt th;
    ModelScladLoskutSale model = new ModelScladLoskutSale();
    ...
    private void initComponents() {
        ...
        jButton4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/org/example/images/basket.png"))); // NOI18N
        jButton4.setText("История");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(h==-1)
            return;
        ScladLoskutSale sl = IOScladLoskut.getScladLoskutSale((int)jTable1.getValueAt(h, 0));
        
        if (JOptionPane.showConfirmDialog(null, "Вы действительно хотите удалить списание, в количестве "+sl.getQty().setScale(2, RoundingMode.HALF_UP)+"?", "Вопрос.", JOptionPane.YES_NO_OPTION) == 0) 
        {
            //sl.setStatus(1);
            IOScladLoskut.delScladLoskutSale(sl.getScladloskutsale());
            
            IOOperationHistory.saveOperationHistory("Удалили списание", sl.getScladloskut().getZadachanastil().getZadachanastil(), 1);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(h==-1)
            return;
        ScladLoskutSale sl = IOScladLoskut.getScladLoskutSale((int)jTable1.getValueAt(h, 0));
        FHistoryOperation fo = new FHistoryOperation(null, true, sl.getScladloskut().getZadachanastil().getZadachanastil(), 1);
        fo.setVisible(true);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        FParamReportPrintRabotnik f = new FParamReportPrintRabotnik(null, true, 44);
        f.setVisible(true);
