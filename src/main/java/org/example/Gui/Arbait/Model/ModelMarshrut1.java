 ...
 * @author ivan
 */
public class ModelMarshrut1  extends AbstractTableModel{
    List<ViewMarshrut> list = new ArrayList<>();
    List<String> listCol = new ArrayList<>();

    public ModelMarshrut1() {
        listCol.add("#");          //0
        ...
        switch(columnIndex)
        {
            ...
            case 8: 
                if(list.get(rowIndex).getStatus()>=5)
                    ...
                    return "";
            case 9: 
                return list.get(rowIndex).getQtysdal()>0?list.get(rowIndex).getQtysdal():"";
            case 10:                 
                return list.get(rowIndex).getBrak()>0?list.get(rowIndex).getBrak():"";                    
            case 11: 
                return list.get(rowIndex).getCsale()>0?list.get(rowIndex).getCsale():"";            
            case 12: 
                return list.get(rowIndex).getBrak1()>0?list.get(rowIndex).getBrak1():"";        
            case 13: 
                return list.get(rowIndex).getDpros()>0?("<html><font color = red>"+list.get(rowIndex).getDpros()+"</font></html>"):"";                        
            case 14: 
                return list.get(rowIndex).getQtysclad()>0?list.get(rowIndex).getQtysclad():"";
            case 15: 
            ...
            case 17: 
                return list.get(rowIndex).getPretenzia();
            case 18: 
                return list.get(rowIndex).getDtext();
        }
        return null;
    }
    ...
    public void setData(Date d1, Date d2, Integer[] s, boolean view_sclad)
    {
        ...
        if(!view_sclad)
            ss[3] = -1;
        list = IOZadachaKomplektovka.getAllMarshrut1(d1,  d2,  ss);
        fireTableDataChanged();
    }
