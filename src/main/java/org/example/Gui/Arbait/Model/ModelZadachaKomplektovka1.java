 ...
 */
public class ModelZadachaKomplektovka1  extends AbstractTableModel{
    List<ZadachaKomplektovka> list = new ArrayList<>();
    List<String> listCol = new ArrayList<>();

    public ModelZadachaKomplektovka1() {
        listCol.add("#");
        listCol.add("Статус");        
        listCol.add("Задача");
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        switch(columnIndex)
        {
            ...
            case 10: 
                return "<html>Цвет:" + list.get(rowIndex).getColor().getName() + "<br> Комплектовщик: " + list.get(rowIndex).getRabotnik().getName()  + "</html>";    
        }
        return null;
    }
