...
import org.example.Gui.model.ModelHistoryFurnitura;
 ...
 * @author ivan
 */
public class FHistoryFurnitura extends javax.swing.JDialog {

    /**
     * Creates new form FHistoryFurnitura
     * @param parent
     * @param modal
     * @param sp1 - строка на складе
     * @param p1 - номер фурнитуры
     */
    public FHistoryFurnitura(java.awt.Frame parent, boolean modal, int sp1, int p1) {
        super(parent, modal);
        initComponents();
        sp = sp1;
        p = p1;
    ...
    int sp;
    int p;
    ModelHistoryFurnitura model = new ModelHistoryFurnitura();
    /**
    ...
    private void initComponents() {
        ...
        jButton2.setText("ИсторияТовара");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FHistoryFurnitura.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FHistoryFurnitura dialog = new FHistoryFurnitura(new javax.swing.JFrame(), true, 0, 0);
