 ...
 * @author ivan
 */
public class FGetFurnituraChex extends javax.swing.JDialog {

    /**
     * Creates new form FGetFurnituraChex
     * @param parent
     * @param modal
     * @param chex
     */
    public FGetFurnituraChex(java.awt.Frame parent, boolean modal, int chex) {
        super(parent, modal);
        initComponents();
        createWindow(0, chex);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetFurnituraChex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetFurnituraChex dialog = new FGetFurnituraChex(new javax.swing.JFrame(), true, 0);
     ...
     * @param s 
     */
    private void createWindow(int s, final int ch)
    {       
        result_id = s;
    ...
    private void openWindows(int c)
    {
        int w = Toolkit.getDefaultToolkit ().getScreenSize().width-50;
