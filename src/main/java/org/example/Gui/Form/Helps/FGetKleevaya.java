 ...
 * @author ivan
 */
public class FGetKleevaya extends javax.swing.JDialog {

    /**
     * Creates new form FGetKleevaya
     * @param parent
     * @param modal
     * @param kl
     */
    public FGetKleevaya(java.awt.Frame parent, boolean modal, int kl) {
        super(parent, modal);
        initComponents();
        createWindow(kl);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetKleevaya.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetKleevaya dialog = new FGetKleevaya(new javax.swing.JFrame(), true, 0);
