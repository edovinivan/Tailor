...
import org.example.Gui.Arbait.Model.ModelMarshrut;
import org.example.Gui.Arbait.Model.ModelMarshrutAll;
 ...
 * Выбор маршрута
 */
public class FGetMarshrut extends javax.swing.JDialog {

    /**
     * Creates new form FGertMarshrut
     * @param parent
     * @param modal
     * @param s
     * @param c - цех
     */
    public FGetMarshrut(java.awt.Frame parent, boolean modal, int s, int c) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetMarshrut.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetMarshrut dialog = new FGetMarshrut(new javax.swing.JFrame(), true, 0, 0);
    ...
    int result_id;
    int cheh;
    ModelMarshrutAll model = new ModelMarshrutAll();
    ...
    private void widthTable()
    {
        ...
        jTable1.getColumnModel().getColumn(14).setPreferredWidth(h);*/
