 ...
 * @author ivan
 */
public class FGetModel extends javax.swing.JDialog {

    /**
     * Creates new form FGetModel
     * @param parent
     * @param modal
     * @param model
     */
    public FGetModel(java.awt.Frame parent, boolean modal, int model) {
        super(parent, modal);
        initComponents();
        createWindow(model);
    }
     ...
     * @param modal
     * @param model
     * @param all - true - показывать только утвержденные
     */
    public FGetModel(java.awt.Frame parent, boolean modal, int model, boolean all) {
        super(parent, modal);
        initComponents();
        all_view = all;
        createWindow(model);
    ...
    private void initComponents() {
        ...
        setTitle("Выбор конфекционной карты");
    ...
    /*public void setTextForSeach(String ss)
    {
        if(ss.length()>0)
        {
            jLabel1.setText(ss);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetModel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetModel dialog = new FGetModel(new javax.swing.JFrame(), true, 0);
