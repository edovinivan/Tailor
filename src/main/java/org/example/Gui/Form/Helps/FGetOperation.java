 ...
 * @author ivan
 */
public class FGetOperation extends javax.swing.JDialog {

    /**
     * Creates new form FGetOperation
     * @param parent
     * @param modal
     * @param s
     * @param m - модель
     */
    public FGetOperation(java.awt.Frame parent, boolean modal, int s, int m) {
        super(parent, modal);
        initComponents();
        md = m;
        createWindow(s);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetOperation.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetOperation dialog = new FGetOperation(new javax.swing.JFrame(), true, 0, 0);
