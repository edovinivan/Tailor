 ...
 * @author ivan
 */
public class FGetOperationGruppa extends javax.swing.JDialog {

    /**
     * Creates new form FGetOperationGruppa
     * @param parent
     * @param modal
     * @param v
     */
    public FGetOperationGruppa(java.awt.Frame parent, boolean modal, int v) {
        super(parent, modal);
        initComponents();
        createWindow(v);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Выбрать группу операций");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetOperationGruppa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetOperationGruppa dialog = new FGetOperationGruppa(new javax.swing.JFrame(), true, 0);
    ...
    int result_id;
    ModelOperationGruppa model = new ModelOperationGruppa();
    /**
     * Результат диалога
     * @return 
     */
