 ...
 * @author edovin.ivan
 */
public class FGetOperationTextGruppa extends javax.swing.JDialog {

    /**
     * Creates new form FGetOperationTextGruppa
     * @param parent
     * @param modal
     */
    public FGetOperationTextGruppa(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        createWindow(0);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Выбрать описание операции");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetOperationTextGruppa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FGetOperationTextGruppa dialog = new FGetOperationTextGruppa(new javax.swing.JFrame(), true);
