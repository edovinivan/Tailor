...
import org.example.Gui.model.ModelRabotnik;
import org.example.Gui.model.ModelTipNastilania;
 ...
 * @author ivan
 */
public class FGetRabotnik extends javax.swing.JDialog {

    /**
     * Creates new form FGetRabotnik
     * @param parent
     * @param modal
     * @param r - работник
     * @param rg - группа работников
     */
    public FGetRabotnik(java.awt.Frame parent, boolean modal, int r, int rg) {
        super(parent, modal);
        initComponents();
        rab_gruppa = rg;
        createWindow(r);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetRabotnik.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetRabotnik dialog = new FGetRabotnik(new javax.swing.JFrame(), true, 0, 0);
    ...
    int result_id;
    ModelRabotnik model;// = new ModelColor();
    /**
     * Результат диалога
     * @return 
     */
