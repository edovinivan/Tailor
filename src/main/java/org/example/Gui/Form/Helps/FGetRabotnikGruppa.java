...
import org.example.Gui.model.ModelOperation;
 ...
 * @author ivan
 */
public class FGetRabotnikGruppa extends javax.swing.JDialog {

    /**
     * Creates new form FGetRabotnikGruppa
     * @param parent
     * @param modal
     * @param s
     */
    public FGetRabotnikGruppa(java.awt.Frame parent, boolean modal, int s) {
        super(parent, modal);
        initComponents();
        createWindow(s);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Выбор группы сотрудников");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetRabotnikGruppa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetRabotnikGruppa dialog = new FGetRabotnikGruppa(new javax.swing.JFrame(), true, 0);
