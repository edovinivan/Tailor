...
import org.example.Gui.model.ModelRazrad;
 ...
 * @author ivan
 */
public class FGetRazrad extends javax.swing.JDialog {

    /**
     * Creates new form FGetRazrad
     * @param parent
     * @param modal
     * @param s
     */
    public FGetRazrad(java.awt.Frame parent, boolean modal, int s) {
        super(parent, modal);
        initComponents();
        createWindow(s);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetRazrad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetRazrad dialog = new FGetRazrad(new javax.swing.JFrame(), true, 0);
    ...
    int result_id;
    ModelRazrad model = new ModelRazrad();
    /**
     * Результат диалога
     * @return 
     */
