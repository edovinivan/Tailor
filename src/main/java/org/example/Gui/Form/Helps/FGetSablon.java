...
import org.example.Gui.model.ModelSablon;
 ...
 * @author ivan
 */
public class FGetSablon extends javax.swing.JDialog {

    /**
     * Creates new form FGetSablonForModel
     * @param parent
     * @param modal
     * @param sabl
     */
    public FGetSablon(java.awt.Frame parent, boolean modal, int sabl) {
        super(parent, modal);
        initComponents();
        createWindow(sabl);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetSablon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetSablon dialog = new FGetSablon(new javax.swing.JFrame(), true,  0);
    ...
    int result_id;
    ModelSablon model = new ModelSablon();
    /**
     * Результат диалога
     * @return 
     */
