 ...
 * @author ivan
 */
public class FGetSclad extends javax.swing.JDialog {

    /**
     * Creates new form FGetSclad
     * @param parent
     * @param modal
     * @param scl
     */
    public FGetSclad(java.awt.Frame parent, boolean modal, int scl) {
        super(parent, modal);
        initComponents();
         createWindow(scl);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetSclad.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetSclad dialog = new FGetSclad(new javax.swing.JFrame(), true, 0);
    ...
    int result_id;
    ModelSclad model;// = new ModelColor();
    /**
     * Результат диалога
     * @return 
     */
