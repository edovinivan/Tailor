 ...
 * @author ivan
 */
public class FGetTipModeli extends javax.swing.JDialog {

    /**
     * Creates new form FGetTipModeli
     * @param parent
     * @param modal
     * @param tm - тип модели
     */
    public FGetTipModeli(java.awt.Frame parent, boolean modal, int tm) {
        super(parent, modal);
        initComponents();
        createWindow(tm);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetTipModeli.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetTipModeli dialog = new FGetTipModeli(new javax.swing.JFrame(), true, 0);
