 ...
 * @author ivan
 */
public class FGetTipNastilania extends javax.swing.JDialog {

    /**
     * Creates new form FGetTipNastilania
     * @param parent
     * @param modal
     * @param s
     */
    public FGetTipNastilania(java.awt.Frame parent, boolean modal, int s) {
        super(parent, modal);
        initComponents();
        createWindow(s);
    }
    ...
    private void initComponents() {
        ...
        setTitle("Выбор типа настилания");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetTipNastilania.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetTipNastilania dialog = new FGetTipNastilania(new javax.swing.JFrame(), true, 0);
    ...
    int result_id;
    ModelTipNastilania model;// = new ModelColor();
    /**
     * Результат диалога
     * @return 
     */
