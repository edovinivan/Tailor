...
import org.example.Gui.model.ModelTipProduct;
 ...
 * @author ivan
 */
public class FGetTipProduct extends javax.swing.JDialog {

    /**
     * Creates new form FGetTipProduct
     * @param parent
     * @param modal
     * @param s
     */
    public FGetTipProduct(java.awt.Frame parent, boolean modal, int s) {
        super(parent, modal);
        initComponents();
        createWindow(s);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FGetTipProduct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                FGetTipProduct dialog = new FGetTipProduct(new javax.swing.JFrame(), true, 0);
    ...
    int result_id;
    ModelTipProduct model = new ModelTipProduct();
    /**
     * Результат диалога
     * @return 
     */
