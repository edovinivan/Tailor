...
import org.example.Gui.Form.FAgent;
 ...
 * @author ivan
 */
public class LAgent extends javax.swing.JPanel {

    /**
     * Creates new form LAgent
     * @param th1
     * @param v
     */
    public LAgent(THaupt th1, int v) {
        initComponents();
        th = th1;
    ...
    private void initComponents() {
        ...
        jToolBar1.setPreferredSize(new java.awt.Dimension(293, 43));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FAgent fa = new FAgent(null, true, 0, vid);
        fa.setVisible(true);
        if(fa.getResult())
            model.setData();
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        // TODO add your handling code here:
        if(IOOperator.getSetupOperator(33)>1 || IOOperator.getSetupOperator(34)>1)
        {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        FAgent fa = new FAgent(null, true, h, vid);
        fa.setVisible(true);
        if(fa.getResult())
            model.setData();
