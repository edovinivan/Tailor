 ...
 * @author ivan
 */
public class LColor extends javax.swing.JPanel {

    /**
     * Creates new form LColor
     * @param th1
     * @param v = вид
     */
    public LColor(THaupt th1, int v) {
        initComponents();
        th= th1;
        vid = v;
        model = new ModelColor(v);
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        if(IOOperator.getSetupOperator(36)>1 || IOOperator.getSetupOperator(37)>1 || IOOperator.getSetupOperator(38)>1)
        {
    ...
    */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        {
            Color col = new Color();
            col.setColor((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setName(fa.getText());
            col.setVid(vid);
            IOColor.setColor(col);
