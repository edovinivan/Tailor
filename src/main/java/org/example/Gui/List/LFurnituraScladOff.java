...
import org.example.Gui.model.ModelFurnituraScladOff;
 ...
 * @author ivan
 */
public class LFurnituraScladOff extends javax.swing.JPanel {

    /**
     * Creates new form LFurnituraScladOff
     * @param th1
     */
    public LFurnituraScladOff(THaupt th1) {
        initComponents();
        th = th1;
    ...
    Date d1, d2;
    THaupt th;
    ModelFurnituraScladOff model = new ModelFurnituraScladOff();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(h==-1) return;
        if (JOptionPane.showConfirmDialog(null, "Вы действительно хотите удалить списание фурнитуры <" + jTable1.getValueAt(h, 1) + ">?", "Вопрос.", JOptionPane.YES_NO_OPTION) == 0) 
        {            
            if(IOFurnituraScladOff.openFurnituraScladOff((int)jTable1.getValueAt(h, 0)))
            {
                if(IOFurnituraScladOff.delFurnituraScladOff((int)jTable1.getValueAt(h, 0)))
                    model.setData(d1, d2);
                else
