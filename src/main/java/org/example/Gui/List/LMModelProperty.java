...
import org.example.Gui.Form.FMModelProperty;
import org.example.Gui.THaupt;
import org.example.Gui.model.ModelMModelProperty;
 ...
 * @author ivan
 */
public class LMModelProperty extends javax.swing.JPanel {

    /**
     * Creates new form LMModelProperty
     * @param th1
     */
    public LMModelProperty(THaupt th1) {
        initComponents();
        th = th1;
    }

    THaupt th;
    ModelMModelProperty model = new ModelMModelProperty();
    /**
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FMModelProperty fm = new FMModelProperty(null, true, 0);
        fm.setVisible(true);
        model.setData();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(h==-1) return;
        FMModelProperty fm = new FMModelProperty(null, true, (int)jTable1.getValueAt(h, 0));
        fm.setVisible(true);
        model.setData();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(h==-1)
            return;        
        if (JOptionPane.showConfirmDialog(null, "Вы действительно хотите удалить значение характеристики <" + jTable1.getValueAt(h, 2) + ">?", "Вопрос.", JOptionPane.YES_NO_OPTION) == 0) 
        {
            IOMProperty.delMModelProperty((int)jTable1.getValueAt(h, 0));
            model.setData();
        }
