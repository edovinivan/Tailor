 ...
 * @author ivan
 */
public class LMeasure extends javax.swing.JPanel {

    /**
     * Creates new form LMeasure
     * @param th1
     */
    public LMeasure(THaupt th1) {
        initComponents();
        th = th1;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fa.getResult())
        {
            Measure col = new Measure();
            col.setMeasure(0);
            col.setDel(0);
            col.setName(fa.getText());
            IOProduct.setMeasure(col);
            model.setData();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            Measure col = new Measure();
            col.setMeasure((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setName(fa.getText());
            IOProduct.setMeasure(col);
            model.setData();            
