 ...
 * @author ivan
 */
public class LOperation extends javax.swing.JPanel {

    /**
     * Creates new form LOperation
     * @param th1
     */
    public LOperation(THaupt th1) {
        initComponents();
        th = th1;
    }
    THaupt th;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FOperation fo = new FOperation(null, true, 0);
        fo.setVisible(true);
        if(fo.getResult())
            model.setData();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        FOperation fo = new FOperation(null, true, (int)jTable1.getValueAt(h, 0));
        fo.setVisible(true);
        if(fo.getResult())
            model.setData();
