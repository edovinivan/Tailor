 ...
 * @author ivan
 */
public class LOperationGruppa extends javax.swing.JPanel {

    /**
     * Creates new form LOperationGruppa
     * @param th1
     */
    public LOperationGruppa(THaupt th1) {
        initComponents();
        th = th1;
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        if(IOOperator.getSetupOperator(35)<2)
        {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fa.getResult())
        {
            OperationGruppa col = new OperationGruppa();
            col.setOperationgruppa(0);
            col.setDel(0);
            col.setName(fa.getText());
            IOOperation.setOperationGruppa(col);
            model.setData();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            OperationGruppa col = new OperationGruppa();
            col.setOperationgruppa((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setName(fa.getText());
            IOOperation.setOperationGruppa(col);
            model.setData();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            if(IOOperation.delOperationGruppa(h))
                model.setData();
            else
