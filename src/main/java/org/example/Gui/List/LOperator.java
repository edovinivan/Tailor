...
import org.example.Gui.Form.FOperator;
import org.example.Gui.THaupt;
import org.example.Gui.model.ModelOperator;
 ...
 * @author ivan
 */
public class LOperator extends javax.swing.JPanel {

    /**
     * Creates new form LOperator
     * @param th1
     */
    public LOperator(THaupt th1) {
        initComponents();
        th = th1;
    }
    
    THaupt th;
    ModelOperator model = new ModelOperator();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FOperator f = new FOperator(null, true, 0);
        f.setVisible(true);
        model.setData();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(h==-1)return;
        FOperator f = new FOperator(null, true, (int)jTable1.getValueAt(h, 0));
        f.setVisible(true);
        model.setData();
