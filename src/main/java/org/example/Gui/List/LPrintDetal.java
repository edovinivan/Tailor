 ...
 * @author ivan
 */
public class LPrintDetal extends javax.swing.JPanel {

    /**
     * Creates new form LPrintDetal
     * @param th1
     * @param v - вид
     */
    public LPrintDetal(THaupt th1, int v) {
        initComponents();
        th = th1;
        model = new ModelPrintDetali(v);
        vid = v;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fa.getResult())
        {
            PrintDetali col = new PrintDetali();
            col.setPrintdetali(0);
            col.setDel(0);
            col.setName(fa.getText());
            col.setVid(vid);
            IOPrintDetali.setPrintDetali(col);
            model.setData();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            PrintDetali col = new PrintDetali();
            col.setPrintdetali((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setVid(vid);
            col.setName(fa.getText());
            IOPrintDetali.setPrintDetali(col);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            if(IOPrintDetali.delPrintDetali(h))
                model.setData();
            else
