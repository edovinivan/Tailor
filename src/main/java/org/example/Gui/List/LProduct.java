...
import org.example.Gui.Form.FProduct;
 ...
 * @author ivan
 */
public class LProduct extends javax.swing.JPanel {

    /**
     * Creates new form LProduct
     * @param th1
     * @param v - вид
     */
    public LProduct(THaupt th1, int v) {
        th = th1;
        initComponents();
        vid = v;
        model.setVid(v);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FProduct fp = new FProduct(null, true, 0, vid);
        fp.setVisible(true);
        if(fp.getResult())
            model.setData();
        
        //LMeasure lm = new LMeasure(th);
        //lm.setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        FProduct fp = new FProduct(null, true, h, vid);
        fp.setVisible(true);
        if(fp.getResult())
            model.setData();
