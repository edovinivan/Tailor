 ...
 * @author ivan
 */
public class LProductGruppa extends javax.swing.JPanel {

    /**
     * Creates new form LProductGruppa
     * @param th1
     * @param v
     */
    public LProductGruppa(THaupt th1, int v) {
        initComponents();
        th = th1;
        model = new ModelProductGruppa(v);
        vid = v;
    }
    int vid;
    THaupt th;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fa.getResult())
        {
            ProductGruppa col = new ProductGruppa();
            col.setProductgruppa(0);
            col.setDel(0);
            col.setName(fa.getText());
            col.setVid(vid);
            IOProduct.setProductGruppa(col);
            model.setData();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            ProductGruppa col = new ProductGruppa();
            col.setProductgruppa((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setName(fa.getText());
            col.setVid(vid);
            IOProduct.setProductGruppa(col);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            if(IOProduct.delProductGruppa(h))
                model.setData();
            else
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        LReport lr = new LReport(null, true, 12,(int)jTable1.getValueAt(jTable1.getSelectedRow(), 0));
        lr.setVisible(true);
