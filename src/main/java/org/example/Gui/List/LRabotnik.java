...
import org.example.Gui.Form.FRabotnik;
 ...
 * @author ivan
 */
public class LRabotnik extends javax.swing.JPanel {

    /**
     * Creates new form LRabotnik
     * @param th1
     */
    public LRabotnik(THaupt th1) {
        initComponents();
        th = th1;
    }
    
    THaupt th;
    ModelRabotnik model = new ModelRabotnik();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FRabotnik rab = new FRabotnik(null, true, 0);
        rab.setVisible(true);
        if(rab.getResult())
            model.setData();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        FRabotnik rab = new FRabotnik(null, true, (int) jTable1.getValueAt(h, 0));
        rab.setVisible(true);
        if(rab.getResult())
            model.setData();
