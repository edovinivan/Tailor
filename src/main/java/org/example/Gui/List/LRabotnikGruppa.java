...
import org.example.Gui.Form.FAddGruppaOperator;
 ...
 * @author ivan
 */
public class LRabotnikGruppa extends javax.swing.JPanel {

    /**
     * Creates new form LRabotnikGruppa
     * @param th1
     */
    public LRabotnikGruppa(THaupt th1) {
        initComponents();
        th = th1;
    }
    THaupt th;
    ModelRabotnikGruppa model = new ModelRabotnikGruppa();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        FAddGruppaOperator fa = new FAddGruppaOperator(null, true);        
        fa.setVisible(true);
        if(fa.getResult())
        {
            RabotnikGruppa col = new RabotnikGruppa();
            col.setRabotnikgruppa(0);
            col.setDel(0);
            col.setName(fa.getNameText());
            col.setGruppa(fa.getGruppa()?1:0);
            IORabotnik.setRabotnikGruppa(col);
            model.setData();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        FAddGruppaOperator fa = new FAddGruppaOperator(null, true);        
        RabotnikGruppa col = IORabotnik.getListRabotnikGruppa((int)jTable1.getValueAt(h, 0)).get(0);
        fa.setData(col.getName(), col.getGruppa()==1);
        fa.setVisible(true);
        if(fa.getResult())
        {
            //RabotnikGruppa col = new RabotnikGruppa();
        ...
        {
            RabotnikGruppa col = new RabotnikGruppa();
            col.setRabotnikgruppa((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            if(IORabotnik.delRabotnikGruppa(h))
                model.setData();
            else
