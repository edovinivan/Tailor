...
import org.example.Gui.model.ModelRaskladchik;
 ...
 * @author ivan
 */
public class LRaskladchik extends javax.swing.JPanel {

    /**
     * Creates new form LRaskladchik
     * @param th1
     */
    public LRaskladchik(THaupt th1) {
        initComponents();
        th = th1;
    }

    THaupt th;
    ModelRaskladchik model = new ModelRaskladchik();
    /**
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fa.getResult())
        {
            Raskladchik col = new Raskladchik();
            col.setRaskladchik(0);
            col.setDel(0);
            col.setName(fa.getText());
            IORaskladchik.setRaskladchik(col);
            model.setData();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            Raskladchik col = new Raskladchik();
            col.setRaskladchik((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setName(fa.getText());
            IORaskladchik.setRaskladchik(col);
            model.setData();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            if(IORaskladchik.delRaskladchik(h))
                model.setData();
            else
