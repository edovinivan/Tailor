...
import org.example.Gui.Analit.FGetARazmer;
import org.example.Gui.Form.FRazmeri;
import org.example.Gui.THaupt;
import org.example.Gui.model.ModelRazmeri;
 ...
 * @author ivan
 */
public class LRazmeri extends javax.swing.JPanel {

    /**
     * Creates new form LRazmeri
     * @param th1
     * @param is1C1 - Если true То это для привязки 1С
     */
    public LRazmeri(THaupt th1, boolean is1C1) {
        initComponents();
        th = th1;
        is1C = is1C1;
    }
    ...
    THaupt th;
    ModelRazmeri model = new ModelRazmeri();
    boolean is1C;
    /**
    ...
    private void initComponents() {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/need.png"))); // NOI18N
        jButton6.setText("Привязать");
    ...
    private void jTable1ComponentResized(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jTable1ComponentResized
        // TODO add your handling code here:
         if(jTable1.getColumnCount()<=0)
            return;
        int h = (jTable1.getWidth()-50)/2;
        if(is1C)
            h = (jTable1.getWidth()-50)/3;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FRazmeri fa = new FRazmeri(null, true, 0);
        fa.setVisible(true);
        if(fa.getResult())
            model.setData();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        FRazmeri fa = new FRazmeri(null, true, (int)jTable1.getValueAt(h, 0));
        fa.setVisible(true);
        if(fa.getResult())
            model.setData();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        int h = jTable1.getSelectedRow();
        if(h==-1) return;
        FGetARazmer fg = new FGetARazmer(null, true, 0);
        fg.setVisible(true);
        if(fg.getResult())
        {
            IOAHelp.snapRazmeri(fg.getResultValue(), (int)jTable1.getValueAt(h, 0));
            model.setData();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        int h = jTable1.getSelectedRow();
        if(h==-1) return;
        IOAHelp.snapRazmeri(0, (int)jTable1.getValueAt(h, 0));
        model.setData();
        jTable1.setRowSelectionInterval(h, h);
