...
import org.example.Gui.model.ModelRazmeriGruppa;
 ...
 * @author ivan
 */
public class LRazmeriGruppa extends javax.swing.JPanel {

    /**
     * Creates new form LRazmeriGruppa
     * @param th1
     */
    public LRazmeriGruppa(THaupt th1) {
        initComponents();
        th = th1;
    }

    THaupt th;
    ModelRazmeriGruppa model = new ModelRazmeriGruppa();
    /**
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fa.getResult())
        {
            RazmeriGruppa col = new RazmeriGruppa();
            col.setRazmerigruppa(0);
            col.setDel(0);
            col.setName(fa.getText());
            IORazmeri.setRazmeriGruppa(col);
            model.setData();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            RazmeriGruppa col = new RazmeriGruppa();
            col.setRazmerigruppa((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setName(fa.getText());
            IORazmeri.setRazmeriGruppa(col);
            model.setData();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            if(IORazmeri.delRazmeriGruppa(h))
                model.setData();
            else
