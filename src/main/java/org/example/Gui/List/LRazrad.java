...
import org.example.Gui.Form.FRazrad;
 ...
 * @author ivan
 */
public class LRazrad extends javax.swing.JPanel {

    /**
     * Creates new form LRazrad
     * @param th1
     */
    public LRazrad(THaupt th1) {
        initComponents();
        th = th1;
    }
    THaupt th;
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FRazrad f = new FRazrad(null, true, 0);
        f.setVisible(true);
        model.setData();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(h==-1) return;
        FRazrad f = new FRazrad(null, true, (int)jTable1.getValueAt(h, 0));
        f.setVisible(true);
        model.setData();
