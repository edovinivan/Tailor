 ...
 * @author ivan
 */
public class LRevizia extends javax.swing.JPanel {

    /**
     * Creates new form LRevizia
     * @param th1
     */
    public LRevizia(THaupt th1) {
        initComponents();
        th = th1;
    ...
    THaupt th;
    Date d1, d2;
    ModelRevizia model = new ModelRevizia();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FRevizia f = new FRevizia(null, true,0);
        f.setVisible(true);
        model.setData(d1, d2);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(h==-1) return;
        FRevizia f = new FRevizia(null, true,(int)jTable1.getValueAt(h, 0));
        f.setVisible(true);
        model.setData(d1, d2);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Вы действительно хотите удалить инвентаризацию №<" + jTable1.getValueAt(jTable1.getSelectedRow(), 2) + ">?", "Вопрос.", JOptionPane.YES_NO_OPTION) == 0) 
        {
            Revizia r = IORevizia.getRevizia(h);
            if(r.getStatus()!=0)
            {
                JOptionPane.showMessageDialog(null, "Документ уже проведен!");
                return;
            }
            if(IORevizia.delRevizia(h))
                model.setData(d1, d2);
            else
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        if(h==-1)
            return;
        h = (int) jTable1.getValueAt(h, 0);
        if (JOptionPane.showConfirmDialog(null, "Вы действительно хотите провести инвентаризацию №<" + jTable1.getValueAt(jTable1.getSelectedRow(), 2) + ">?", "Вопрос.", JOptionPane.YES_NO_OPTION) == 0) 
        {
            
            if(IORevizia.closeRevizia(h))
                model.setData(d1, d2);            
        }
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        if(h==-1)
            return;
        h = (int) jTable1.getValueAt(h, 0);
        if (JOptionPane.showConfirmDialog(null, "Вы действительно хотите открыть инвентаризацию №<" + jTable1.getValueAt(jTable1.getSelectedRow(), 2) + ">?", "Вопрос.", JOptionPane.YES_NO_OPTION) == 0) 
        {
            
            if(IORevizia.openRevizia(h))
                model.setData(d1, d2);            
        }
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        LReport lr = new LReport(null, true,14 ,(int)jTable1.getValueAt(jTable1.getSelectedRow(), 0));
        lr.setVisible(true);
