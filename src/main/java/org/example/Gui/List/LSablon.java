 ...
 * @author ivan
 */
public class LSablon extends javax.swing.JPanel {

    /**
     * Creates new form LSablon
     * @param th1
     */
    public LSablon(THaupt th1) {
        initComponents();
        th = th1;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fa.getResult())
        {
            Sablon col = new Sablon();
            col.setSablon(0);
            col.setDel(0);
            col.setName(fa.getText());
            IOSablon.setSablon(col);
            model.setData();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            Sablon col = new Sablon();
            col.setSablon((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setName(fa.getText());
            IOSablon.setSablon(col);
            model.setData();            
