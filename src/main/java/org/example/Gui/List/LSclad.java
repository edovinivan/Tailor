 ...
 * @author ivan
 */
public class LSclad extends javax.swing.JPanel {

    /**
     * Creates new form LSclad
     * @param th1
     */
    public LSclad(THaupt th1) {
        initComponents();
        th = th1;
    }

    THaupt th;
    ModelSclad model = new ModelSclad();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {            
            Sclad col = new Sclad();
            col.setSclad((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setName(fa.getText());
            IOSclad.setSclad(col);
            model.setData();            
