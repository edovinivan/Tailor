...
import org.example.Gui.Form.FTipModel;
import org.example.Gui.Form.Helps.FAddName;
import org.example.Gui.THaupt;
import org.example.Gui.model.ModelTipModel;
 ...
 * @author ivan
 */
public class LTipModel extends javax.swing.JPanel {

    /**
     * Creates new form LTipModel
     * @param th1
     */
    public LTipModel(THaupt th1) {
        initComponents();
        th = th1;
    }
    
    THaupt th;
    ModelTipModel model = new ModelTipModel();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fa.getResult())
        {
            TipModel col = new TipModel();
            col.setTipmodel(0);
            col.setDel(0);
            col.setName(fa.getText());
            IOTipModel.setTipModel(col);
            model.setData();
        }*/
        FTipModel ft = new FTipModel(null, true, 0);
        ft.setVisible(true);
        if(ft.getResult())
            model.setData();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        FTipModel ft = new FTipModel(null, true, (int)jTable1.getValueAt(h, 0));
        ft.setVisible(true);
        if(ft.getResult())
            model.setData();
        ...
        {            
            TipModel col = new TipModel();
            col.setTipmodel((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setName(fa.getText());
            IOTipModel.setTipModel(col);
            model.setData();            
