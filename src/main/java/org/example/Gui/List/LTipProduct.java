 ...
 * @author ivan
 */
public class LTipProduct extends javax.swing.JPanel {

    /**
     * Creates new form LTipProduct
     * @param th1
     */
    public LTipProduct(THaupt th1) {
        initComponents();
        th = th1;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(fa.getResult())
        {
            TipProduct col = new TipProduct();
            col.setTipproduct(0);
            col.setDel(0);
            col.setName(fa.getText());
            IOTipProduct.setTipProduct(col);
            model.setData();
        }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        {
            TipProduct col = new TipProduct();
            col.setTipproduct((int)jTable1.getValueAt(h, 0));
            col.setDel(0);
            col.setName(fa.getText());
            IOTipProduct.setTipProduct(col);
            model.setData();            
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        {
            if(IOTipProduct.delTipProduct(h))
                model.setData();
            else
