 ...
 * @author ivan
 */
public class LTimeOpChex extends javax.swing.JPanel {

    /**
     * Creates new form LTimeOpChex
     * @param th1
     */
    public LTimeOpChex(THaupt th1) {
        initComponents();
        th = th1;
    }

    THaupt th;
    ModelTimeOpChex model = new ModelTimeOpChex();
    /**
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        // TODO add your handling code here:
        FTimeOpChex ft = new FTimeOpChex(null, true, 0);
        ft.setVisible(true);
        model.setData();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(h==-1) return;
        FTimeOpChex ft = new FTimeOpChex(null, true, (int)jTable1.getValueAt(h, 0));
        ft.setVisible(true);
        model.setData();
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(h==-1)
            return;        
        if (JOptionPane.showConfirmDialog(null, "Вы действительно хотите удалить операцию <" + jTable1.getValueAt(h, 3) + ">?", "Вопрос.", JOptionPane.YES_NO_OPTION) == 0) 
        {
            if(IOTimeOpChex.delPTimeOpChex((int)jTable1.getValueAt(h, 0)))
                model.setData();
            else
